...
class Game2:
    ...
    def setup(self, selected_character, selected_character2, selected_character3, selected_character4):
        ...
        self.Level.write("LEVEL 2", align="left", font=("Times New Roman", 15, "normal"))
        ...
        self.Timer.write("Timer : 135", align="left", font=("Times New Roman", 15, "normal"))
        ...
        self.levels = [""]
        self.level_2 = [
            "XXXXXXXXXXXXXXXXXXXX4XXXXX",
            "XXXP    16XXX  XX       XX",
            "XXXX3XX XXX     7XX XXXXXX",
            "X T XXX   X XXXXX   3X XXX",
            "XX    5X  X XXXX2      XXX",
            "X6    XX           E XXXXX",
            "XXX   XX  5XXXXXX       4X",
            "XX2   XX       XX1XXT   XX",
            ...
            "XX   XXX6      XXXXXXX1  X",
            "XX         XX4XXX3XXX   XX",
            "XX  XX2XXXXXXXXXXXXT     X",
            "XX       61XXXXXXXXX2   XX",
            "XXX  X7      XXX5X XXX  XX",
            "XXXX   E   X2X          XX",
            "XXXXX5XXX       XXX16XXXXX",
            "XXTXX     XXX2XXX XXXXXXXX",
            "XX  X         XXX XX  TXXX",
            "XX  3      XXXXX3 X     XX",
            "X5  XX     X  XXX XX   XXX",
            "XX  XX2X   5   X  XX     7",
