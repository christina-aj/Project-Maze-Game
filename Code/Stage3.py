...
class Game3:
    ...
    def setup(self, selected_character, selected_character2, selected_character3, selected_character4):
        ...
        self.Level.write("LEVEL 3", align="left", font=("Times New Roman", 15, "normal"))
        ...
        self.Timer.write("Timer : 120", align="left", font=("Times New Roman", 15, "normal"))
        ...
        self.levels = [""]
        self.level_3 = [
            "XXXX3XXXXXXXXXXXXXXX6XXXXX",
            "X     E    2XPXX         X",
            "X  1       TX X       X  X",
            "X  XX4X     X 4    X3XX  X",
            "X  XXXX3XXX    5XXXXXXX  X",
            "X            X           X",
            "X  XX2XXXXXXXX4XXXXXXXX  X",
            "X  XXXXXXX1XXTXXXXXXX55  X",
            "X                        X",
            "X       XXX2XXXXXXX      X",
            "X  EXX        TXXXX6     X",
            "X      4XXXXXX5XXX       7",
            "X                        X",
            "X  XXXXX XXXXXXXXX  5XX  X",
